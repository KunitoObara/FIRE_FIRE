 ...
 *
 * A1・A4の「Googleで続ける」(`GoogleSignInButton`)とB10のログイン方法一覧
 * (`LinkedProviderRow`)で共用する。表示の大きさだけ呼び出し側に委ねる。
 */
export const GoogleIcon = ({ className = "size-4" }: GoogleIconProps): JSX.Element => (
