...
- **現時点で破線の遷移は無い。** この規約は[B6-2](https://trello.com/c/amf5APQu)で先に決めたもので、B6→B5の「削除」に適用する予定だったが、着手時点で[B6-1](https://trello.com/c/0Frlp1Q1)が実装を終えていた。次に未実装の遷移を図へ載せる人が迷わないよう、規約だけを残してある
