...
- 現在該当するのは **A1の「承認されていないメールアドレス」のエラー表示**(docs/screen-requirements-auth.md A1「遷移条件」)。ベータ期間中のサインアップ制限([X5](https://trello.com/c/5k33KGEY)、docs/auth-login-requirements.md 3.10)で入る
